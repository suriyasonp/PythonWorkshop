...
mainWindow = Tk()
Button(mainWindow, text="Click me", width=20, command=sayHelloWorld).grid(row=0)
...
Label(mainWindow, text=sayHelloWorld(), width=30, background="#CCCCCC").grid(row=3, column=2)
mainWindow.mainloop()
